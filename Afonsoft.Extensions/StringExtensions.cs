...
namespace Afonsoft.Extensions
{
    ...
    public static class StringExtensions
    {
        ...
        public static string FormartSize(this long value)
        {
            return FormartSize((double) value);
        }
        ...
        /// <summary>
            ...
            /// <param name="value">o valor em bytes</param>
            /// <returns>Retorna o valor em KB, MB,GB, TB</returns>
            public static string FormartSize(this double value)
        {
            if (value > 1024)
            {
                value = value / 1024;
